...
class RImage extends RAbstractImage
{
    ...
    public function crop(PointInterface $start, BoxInterface $size)
    {
        ...
        try {
            ...
            throw new RuntimeException('Imagick: Crop operation failed', $e->getCode(), $e);
        }
        $this->size = array($width, $height);
    ...
    public function rotate($angle, ColorInterface $background = null)
    {
        ...
        try {
            ...
            throw new RuntimeException('Imagick: Rotate operation failed. ' . $e->getMessage(), $e->getCode(), $e);
        }
    ...
    protected function load($size = null)
    {
        try {
            ...
            throw new RuntimeException("Imagick: Unable to open image {$this->filename}. {$e->getMessage()}", $e->getCode(), $e);
        }
        if ($this->format === IMG_JPG && $size !== null) {
